...
?>
	...
	InitWAN: function ()
	{
		...
		else if ((XG(this.waninetp+"/addrtype") == "ipv6")&& wancable_status==1)
		{
			...
			//+++ Jerry Kao, modified for "Connection Up Time" of STATIC mode.
			//if(str_wantype == "STATIC" || str_wantype == "6IN4" || str_wantype == "6TO4" || str_wantype == "6RD")
			if(str_wantype == "STATIC" || str_wantype == "6IN4" || str_wantype == "6TO4")			
			{
	...
	InitLAN: function()
	{
		...
		//+++ Jerry Kao, Determining child using /inf instead of /runtime, but
		//               others still get value from /runtime.
		var rwan  = PXML.FindModule("INET.WAN-4");
		var child = XG(rwan+"/inf/child");	
